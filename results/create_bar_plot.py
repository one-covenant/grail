#!/usr/bin/env python3
"""
Create a bar plot comparing base model vs trained model on MATH test set.
...
def create_bar_plot() -> None:
    ...
    ax.set_title("MATH Test Set Performance", fontweight="bold", pad=20, fontsize=26)
    ...
    # Save
    output_path = Path(__file__).parent / "math_test_performance.png"
    fig.savefig(
        output_path,
        dpi=200,
