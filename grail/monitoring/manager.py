...
class MonitoringManager:
    ...
    async def log_counter(self, name: str, value: Union[int, float] = 1,
        ...
        metric = MetricData(
            name, value, MetricType.COUNTER, tags,
    ...
    async def log_gauge(self, name: str, value: Union[int, float],
                        tags: Optional[Dict[str, str]] = None) -> None:
        """Log a gauge metric.
        ...
        metric = MetricData(
            name, value, MetricType.GAUGE, tags,
            block_number=self._current_block,
            window_number=self._current_window
        )
        try:
    ...
    async def log_histogram(self, name: str, value: Union[int, float],
        ...
        metric = MetricData(
            name, value, MetricType.HISTOGRAM, tags,
            block_number=self._current_block,
            window_number=self._current_window
        )
        self._metric_buffer.append(metric)
