...
if __name__ == "__main__":
    ...
    # Test GSM8K
    gsm8k_completion = f"""{_cfg.thinking_open}
Let me solve this step by step.
If John has 5 apples and gets 3 more, he has 5 + 3 = 8 apples.
{_cfg.thinking_close}
{_cfg.solution_open}8{_cfg.solution_close}"""
    ...
    # Test MATH
    math_completion = f"""{_cfg.thinking_open}
We need to find x such that x^2 = 4.
x = 2 or x = -2
{_cfg.thinking_close}
{_cfg.solution_open}2{_cfg.solution_close}"""
    ...
    # Test MBPP
    mbpp_completion = f"""{_cfg.thinking_open}
